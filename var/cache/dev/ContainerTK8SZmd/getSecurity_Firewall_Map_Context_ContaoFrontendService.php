...
class getSecurity_Firewall_Map_Context_ContaoFrontendService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $f = ($container->privates['debug.security.event_dispatcher.contao_frontend'] ?? self::getDebug_Security_EventDispatcher_ContaoFrontendService($container));
        ...
        return $container->privates['security.firewall.map.context.contao_frontend'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () use ($container) {
            ...
            yield 2 => ($container->privates['debug.security.firewall.authenticator.contao_frontend'] ?? $container->load('getDebug_Security_Firewall_Authenticator_ContaoFrontendService'));
            yield 3 => ($container->privates['security.access_listener'] ?? $container->load('getSecurity_AccessListenerService'));
        }, 4), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($g, ($container->services['security.authentication.trust_resolver'] ?? self::getSecurity_Authentication_TrustResolverService($container)), $a, 'contao_frontend', $b, NULL, new \Contao\CoreBundle\Security\Authentication\AccessDeniedHandler($c, $d, $e), ($container->privates['monolog.logger.security'] ?? self::getMonolog_Logger_SecurityService($container)), false), new \Symfony\Component\Security\Http\Firewall\LogoutListener($g, $a, $f, ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'contao_frontend_logout']), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('contao_frontend', 'contao.security.user_checker', 'contao.routing.frontend_matcher', true, false, 'contao.security.frontend_user_provider', 'contao_frontend', 'contao.security.login_authenticator.contao_frontend', 'contao.security.access_denied_handler', NULL, ['login_throttling', 'contao_login', 'remember_me'], NULL, ['path' => 'contao_frontend_logout', 'enable_csrf' => NULL, 'csrf_token_id' => 'logout', 'csrf_parameter' => '_csrf_token', 'target' => '/', 'invalidate_session' => true, 'clear_site_data' => [], 'delete_cookies' => []]));
    }
}
