...
class getContao_Listener_PrettyErrorScreenService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['contao.listener.pretty_error_screen'] = new \Contao\CoreBundle\EventListener\PrettyErrorScreenListener(false, $a, ($container->services['contao.framework'] ?? self::getContao_FrameworkService($container)), $b, $c, $d, ($container->services['contao.routing.page_finder'] ?? self::getContao_Routing_PageFinderService($container)));
    }
}
