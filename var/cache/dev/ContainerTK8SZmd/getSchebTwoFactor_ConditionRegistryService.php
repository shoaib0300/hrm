 ...
 */
class getSchebTwoFactor_ConditionRegistryService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['scheb_two_factor.condition_registry'] = $container->createProxy('TwoFactorConditionRegistryGhost45a79ab', static fn () => \TwoFactorConditionRegistryGhost45a79ab::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
        ...
        return ($lazyLoad->__construct(new RewindableGenerator(function () use ($container) {
            ...
            yield 2 => ($container->privates['scheb_two_factor.trusted_device_condition'] ?? $container->load('getSchebTwoFactor_TrustedDeviceConditionService'));
        }, 3)) && false ?: $lazyLoad);
    }
}
