 ...
 */
class getSchebTwoFactor_IpWhitelistConditionService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['scheb_two_factor.ip_whitelist_condition'] = $container->createProxy('IpWhitelistConditionGhostFd5f98c', static fn () => \IpWhitelistConditionGhostFd5f98c::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
