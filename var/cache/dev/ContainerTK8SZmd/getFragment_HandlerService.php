...
class getFragment_HandlerService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['fragment.handler'] = new \Contao\CoreBundle\Fragment\FragmentHandler(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'hinclude' => '?',
            'inline' => '?',
        ]), $b, true), $b, ($container->services['contao.fragment.registry'] ?? self::getContao_Fragment_RegistryService($container)), new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], []), $a, true);
    }
}
