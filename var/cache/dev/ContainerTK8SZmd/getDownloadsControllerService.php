 ...
 */
class getDownloadsControllerService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
     * Gets the public 'Contao\CoreBundle\Controller\ContentElement\DownloadsController' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Contao\\CoreBundle\\Controller\\ContentElement\\DownloadsController'] = $instance = new \Contao\CoreBundle\Controller\ContentElement\DownloadsController(($container->services['security.helper'] ?? self::getSecurity_HelperService($container)), ($container->privates['contao.filesystem.virtual.files'] ?? $container->load('getContao_Filesystem_Virtual_FilesService')));

        $instance->setContainer(($container->privates['.service_locator.Xxy2XMy'] ?? $container->load('get_ServiceLocator_Xxy2XMyService'))->withContext('Contao\\CoreBundle\\Controller\\ContentElement\\DownloadsController', $container));
