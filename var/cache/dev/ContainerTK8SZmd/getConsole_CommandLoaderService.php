...
class getConsole_CommandLoaderService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'contao.command.cron_list' => ['privates', '.contao.command.cron_list.lazy', 'get_Contao_Command_CronList_LazyService', true],
            ...
            'contao.command.supervise_workers' => ['privates', '.contao.command.supervise_workers.lazy', 'get_Contao_Command_SuperviseWorkers_LazyService', true],
            ...
            'contao_manager.command.dotenv_dump' => ['privates', '.contao_manager.command.dotenv_dump.lazy', 'get_ContaoManager_Command_DotenvDump_LazyService', true],
            'contao_manager.command.install_skeleton' => ['privates', '.contao_manager.command.install_skeleton.lazy', 'get_ContaoManager_Command_InstallSkeleton_LazyService', true],
