 ...
 */
class getMessenger_Transport_ContaoPrioNormalService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
     * Gets the private 'messenger.transport.contao_prio_normal' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['messenger.transport.contao_prio_normal'])) {
            return $container->privates['messenger.transport.contao_prio_normal'];
        }

        return $container->privates['messenger.transport.contao_prio_normal'] = $a->createTransport('doctrine://default?table_name=tl_message_queue&queue_name=prio_normal&auto_setup=false', ['transport_name' => 'contao_prio_normal'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}
