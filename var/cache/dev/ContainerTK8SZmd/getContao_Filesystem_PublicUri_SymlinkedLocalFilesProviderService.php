...
class getContao_Filesystem_PublicUri_SymlinkedLocalFilesProviderService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['contao.filesystem.public_uri.symlinked_local_files_provider'] = new \Contao\CoreBundle\Filesystem\PublicUri\SymlinkedLocalFilesProvider(($container->privates['contao.filesystem.adapter.files'] ?? $container->load('getContao_Filesystem_Adapter_FilesService')), 'files', ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()));
    }
}
