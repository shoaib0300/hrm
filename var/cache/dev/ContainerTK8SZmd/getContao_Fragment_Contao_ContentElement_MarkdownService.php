...
class getContao_Fragment_Contao_ContentElement_MarkdownService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = $container->load('get_ServiceLocator_1Au3X34_Contao_Fragment_Contao_ContentElement_MarkdownService');

        $instance->setContainer($a);
        $instance->setFragmentOptions(['type' => 'markdown', 'category' => 'texts', 'template' => 'content_element/markdown', 'method' => NULL, 'renderer' => NULL, 'nestedFragments' => false, 'debugController' => 'Contao\\CoreBundle\\Controller\\ContentElement\\MarkdownController']);
        $instance->setContainer($a);
