 ...
 */
class getMessenger_Transport_ContaoPrioLowService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
     * Gets the private 'messenger.transport.contao_prio_low' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['messenger.transport.contao_prio_low'])) {
            return $container->privates['messenger.transport.contao_prio_low'];
        }

        return $container->privates['messenger.transport.contao_prio_low'] = $a->createTransport('doctrine://default?table_name=tl_message_queue&queue_name=prio_low&auto_setup=false', ['transport_name' => 'contao_prio_low'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}
