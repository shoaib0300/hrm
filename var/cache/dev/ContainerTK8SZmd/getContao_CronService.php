...
class getContao_CronService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['contao.cron'] = $instance = new \Contao\CoreBundle\Cron\Cron(#[\Closure(name: 'contao.repository.cron_job', class: 'Contao\\CoreBundle\\Repository\\CronJobRepository')] fn () => ($container->privates['contao.repository.cron_job'] ?? $container->load('getContao_Repository_CronJobService')), #[\Closure(name: 'doctrine.orm.default_entity_manager', class: 'Doctrine\\ORM\\EntityManager')] fn () => ($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container)), ($container->services['cache.app'] ?? self::getCache_AppService($container)), ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)));
