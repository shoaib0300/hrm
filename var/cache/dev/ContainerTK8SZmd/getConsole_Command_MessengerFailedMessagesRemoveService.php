 ...
 */
class getConsole_Command_MessengerFailedMessagesRemoveService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['console.command.messenger_failed_messages_remove'] = $instance = new \Symfony\Component\Messenger\Command\FailedMessagesRemoveCommand('contao_failure', ($container->privates['.service_locator.Tg_1qKJ'] ?? $container->load('get_ServiceLocator_Tg1qKJService')), ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
