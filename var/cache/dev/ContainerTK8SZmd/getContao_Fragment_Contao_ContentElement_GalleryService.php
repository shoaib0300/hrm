 ...
 */
class getContao_Fragment_Contao_ContentElement_GalleryService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = $container->load('get_ServiceLocator_98PWvJa_Contao_Fragment_Contao_ContentElement_GalleryService');

        $instance->setContainer($a);
        $instance->setFragmentOptions(['type' => 'gallery', 'category' => 'media', 'template' => 'content_element/gallery', 'method' => NULL, 'renderer' => NULL, 'nestedFragments' => false, 'debugController' => 'Contao\\CoreBundle\\Controller\\ContentElement\\ImagesController']);
        $instance->setContainer($a);
