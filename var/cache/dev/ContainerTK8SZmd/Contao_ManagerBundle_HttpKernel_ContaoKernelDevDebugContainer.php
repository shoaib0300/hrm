...
class Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'Contao\\CoreBundle\\Controller\\AltchaController' => 'getAltchaControllerService',
            ...
            'contao.altcha' => 'getContao_AltchaService',
            ...
            'contao.listener.P51ceSn' => 'getContao_Listener_P51ceSnService',
            ...
            'contao.listener.kor5vFl' => 'getContao_Listener_Kor5vFlService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/friendsofsymfony/http-cache-bundle/src/EventListener/AttributesListener.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/contao/core-bundle/src/Twig/Inspector/InspectorNodeVisitor.php';
    ...
    protected static function get_Container_Private_ProfilerService($container)
    {
        ...
        $container->services['.container.private.profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage(('file:'.$container->targetDir.''.'/profiler')), $b, true);

        $c = ($container->services['kernel'] ?? $container->get('kernel'));
        $d = ($container->services['.virtual_request_stack'] ?? self::get_VirtualRequestStackService($container));
        ...
        $instance->add(new \Symfony\Component\HttpKernel\DataCollector\TimeDataCollector($c, ($container->services['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true))));
        $instance->add(new \Symfony\Component\HttpKernel\DataCollector\MemoryDataCollector());
        $instance->add(new \Symfony\Component\HttpKernel\DataCollector\AjaxDataCollector());
        $instance->add(new \Symfony\Component\HttpKernel\DataCollector\ExceptionDataCollector());
        $instance->add(new \Symfony\Component\HttpKernel\DataCollector\LoggerDataCollector($b, ($container->targetDir.''.'/Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer'), $d));
        $instance->add(new \Symfony\Component\HttpKernel\DataCollector\EventDataCollector(new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.event_dispatcher.contao_backend' => ($container->privates['debug.security.event_dispatcher.contao_backend'] ?? self::getDebug_Security_EventDispatcher_ContaoBackendService($container));
            yield 'security.event_dispatcher.contao_frontend' => ($container->privates['debug.security.event_dispatcher.contao_frontend'] ?? self::getDebug_Security_EventDispatcher_ContaoFrontendService($container));
        }, 3), $d));
        ...
        $instance->add(new \Symfony\Component\Translation\DataCollector\TranslationDataCollector(($container->privates['contao.translation.data_collector_translator'] ?? self::getContao_Translation_DataCollectorTranslatorService($container))));
        $instance->add(new \Symfony\Bundle\SecurityBundle\DataCollector\SecurityDataCollector(($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), ($container->privates['security.role_hierarchy'] ??= new \Symfony\Component\Security\Core\Role\RoleHierarchy([])), ($container->services['security.logout_url_generator'] ?? self::getSecurity_LogoutUrlGeneratorService($container)), ($container->privates['debug.security.access.decision_manager'] ?? self::getDebug_Security_Access_DecisionManagerService($container)), ($container->services['security.firewall.map'] ?? self::getSecurity_Firewall_MapService($container)), ($container->privates['debug.security.firewall'] ?? self::getDebug_Security_FirewallService($container))));
        ...
        $instance->add(($container->privates['contao.data_collector'] ?? self::getContao_DataCollectorService($container)));
        $instance->add($g);
    ...
    protected static function getAssets_PackagesService($container)
    {
        ...
        $c = ($container->privates['.debug.http_client'] ?? self::get_Debug_HttpClientService($container));
        $d = ($container->services['contao.assets.assets_context'] ?? self::getContao_Assets_AssetsContextService($container));
        $e = new \Symfony\Component\Asset\PathPackage('assets/ace', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.36.2', '%s?v=%s'), $d);
        $f = new \Symfony\Component\Asset\PathPackage('assets/altcha', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('0.9.0', '%s?v=%s'), $d);
        $g = new \Symfony\Component\Asset\PathPackage('assets/chosen', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('2.0.2', '%s?v=%s'), $d);
        $h = new \Symfony\Component\Asset\PathPackage('assets/colorbox', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.6.4.2', '%s?v=%s'), $d);
        $i = new \Symfony\Component\Asset\PathPackage('assets/colorpicker', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.5.3', '%s?v=%s'), $d);
        $j = new \Symfony\Component\Asset\PathPackage('assets/contao', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('9.3.6', '%s?v=%s'), $d);
        $k = new \Symfony\Component\Asset\PathPackage('assets/datepicker', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('3.0.0', '%s?v=%s'), $d);
        $l = new \Symfony\Component\Asset\PathPackage('assets/dropzone', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('5.9.3', '%s?v=%s'), $d);
        $m = new \Symfony\Component\Asset\PathPackage('assets/handorgel', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.0.0.1', '%s?v=%s'), $d);
        $n = new \Symfony\Component\Asset\PathPackage('assets/jquery', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('3.7.1', '%s?v=%s'), $d);
        $o = new \Symfony\Component\Asset\PathPackage('assets/jquery-ui', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.13.2', '%s?v=%s'), $d);
        $p = new \Symfony\Component\Asset\PathPackage('assets/mediabox', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.5.4.3', '%s?v=%s'), $d);
        $q = new \Symfony\Component\Asset\PathPackage('assets/mootools', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.6.0.9', '%s?v=%s'), $d);
        $r = new \Symfony\Component\Asset\PathPackage('assets/simplemodal', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('3.0.2', '%s?v=%s'), $d);
        $s = new \Symfony\Component\Asset\PathPackage('assets/swipe', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('2.2.2', '%s?v=%s'), $d);
        $t = new \Symfony\Component\Asset\PathPackage('assets/swiper', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('11.1.12', '%s?v=%s'), $d);
        $u = new \Symfony\Component\Asset\PathPackage('assets/tablesort', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('4.0.2', '%s?v=%s'), $d);
        $v = new \Symfony\Component\Asset\PathPackage('assets/tablesorter', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('2.31.3.1', '%s?v=%s'), $d);
        $w = new \Symfony\Component\Asset\PathPackage('assets/tinymce4', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('7.3.0', '%s?v=%s'), $d);
        $x = new \Symfony\Component\Asset\PathPackage('assets/tristen-tablesort', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('5.3.1', '%s?v=%s'), $d);
        ...
        $instance->addPackage('contao-components/ace', $e);
        $instance->addPackage('contao-components/altcha', $f);
        $instance->addPackage('contao-components/chosen', $g);
        $instance->addPackage('contao-components/colorbox', $h);
        $instance->addPackage('contao-components/colorpicker', $i);
        $instance->addPackage('contao-components/contao', $j);
        $instance->addPackage('contao-components/datepicker', $k);
        $instance->addPackage('contao-components/dropzone', $l);
        $instance->addPackage('contao-components/handorgel', $m);
        $instance->addPackage('contao-components/jquery', $n);
        $instance->addPackage('contao-components/jquery-ui', $o);
        $instance->addPackage('contao-components/mediabox', $p);
        $instance->addPackage('contao-components/mootools', $q);
        $instance->addPackage('contao-components/simplemodal', $r);
        $instance->addPackage('contao-components/swipe', $s);
        $instance->addPackage('contao-components/swiper', $t);
        $instance->addPackage('contao-components/tablesort', $u);
        $instance->addPackage('contao-components/tablesorter', $v);
        $instance->addPackage('contao-components/tinymce4', $w);
        $instance->addPackage('contao-components/tristen-tablesort', $x);
        $instance->addPackage('contao-components/ace', $e);
        $instance->addPackage('contao-components/altcha', $f);
        $instance->addPackage('contao-components/chosen', $g);
        $instance->addPackage('contao-components/colorbox', $h);
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('aDTP6yeXbK', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('yMslxgXwWH', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6I1i520LM1', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WSnZ9qcNkV', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['contao.assets.assets_context'] = new \Contao\CoreBundle\Asset\ContaoContext(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'staticPlugins', true);
    }
    ...
    {
        return $container->services['contao.assets.files_context'] = new \Contao\CoreBundle\Asset\ContaoContext(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'staticFiles', true);
    }
    ...
    {
        $container->services['contao.framework'] = $instance = new \Contao\CoreBundle\Framework\ContaoFramework(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), \dirname(__DIR__, 4), 8183);

        $instance->setContainer($container);
        $instance->setHookListeners(['getSystemMessages' => [[['contao.listener.administrator_email', '__invoke'], ['contao.listener.data_container.personal_data_password', '__invoke']]], 'loadDataContainer' => [200 => [['contao.listener.data_container.default_global_operations', '__invoke'], ['contao.listener.data_container.default_operations', '__invoke'], ['contao.listener.data_container.enum_options', '__invoke']], 0 => [['contao.listener.data_container.preview_link', 'unloadTableWithoutPreviewScript'], ['contao.listener.data_container.record_preview', 'registerDeleteCallbacks'], ['contao_comments.listener.data_container.add_comment_fields', '__invoke']], -16 => [['contao.listener.data_container_callback', 'onLoadDataContainer']]], 'initializeSystem' => [255 => [['contao.listener.kor5vFl', 'onInitializeSystem'], ['contao.listener.P51ceSn', 'onInitializeSystem']], 0 => [['contao.listener.data_container.preview_link', 'unloadModuleWithoutPreviewScript']]], 'addCustomRegexp' => [[['contao.listener.widget.custom_rgxp', '__invoke'], ['contao.listener.widget.http_url', '__invoke']]], 'getPageStatusIcon' => [[['contao_news.listener.data_container.page', 'getStatusIcon']]], 'generatePage' => [[['contao_news.listener.generate_page', '__invoke'], ['contao_calendar.listener.generate_page', '__invoke']]]]);
    ...
    protected static function getContao_Routing_PageFinderService($container)
    {
        ...
        return $container->services['contao.routing.page_finder'] = new \Contao\CoreBundle\Routing\PageFinder(($container->services['contao.framework'] ?? self::getContao_FrameworkService($container)), $a, ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()));
    }
    ...
    protected static function getContao_Routing_PageRegistryService($container)
    {
        ...
        $instance->add('news_feed', new \Contao\CoreBundle\Routing\Page\RouteConfig(NULL, NULL, NULL, [], [], ['_controller' => 'contao_news.controller.page.news_feed'], []), ($container->services['contao_news.controller.page.news_feed'] ?? self::getContaoNews_Controller_Page_NewsFeedService($container)), false);
    ...
    protected static function getContao_Twig_FilesystemLoaderService($container)
    {
        ...
        $c = ($container->privates['contao.twig.loader.theme_namespace'] ??= new \Contao\CoreBundle\Twig\Loader\ThemeNamespace());

        return $container->services['contao.twig.filesystem_loader'] = new \Contao\CoreBundle\Twig\Loader\ContaoFilesystemLoader(($container->services['cache.system'] ?? self::getCache_SystemService($container)), new \Contao\CoreBundle\Twig\Loader\TemplateLocator(\dirname(__DIR__, 4), $container->parameters['kernel.bundles'], $container->parameters['kernel.bundles_metadata'], $c, $a), $c, ($container->services['contao.framework'] ?? self::getContao_FrameworkService($container)), $b, \dirname(__DIR__, 4));
    }
    ...
    protected static function getDoctrine_Dbal_DefaultConnectionService($container)
    {
        ...
        $d = new \Monolog\Logger('doctrine');
        $d->pushProcessor(($container->privates['contao.monolog.processor'] ?? self::getContao_Monolog_ProcessorService($container)));
        $d->pushProcessor(($container->privates['contao_manager.monolog.request_processor'] ??= new \Contao\ManagerBundle\Monolog\RequestProcessor()));
        $d->pushHandler(($container->privates['monolog.handler.console_very_verbose'] ?? self::getMonolog_Handler_ConsoleVeryVerboseService($container)));
        $d->pushHandler($a);
        ($container->privates['debug.debug_logger_configurator'] ?? self::getDebug_DebugLoggerConfiguratorService($container))->pushDebugLogger($d);
        $e = new \Doctrine\Bundle\DoctrineBundle\Middleware\DebugMiddleware(($container->privates['doctrine.debug_data_holder'] ??= new \Doctrine\Bundle\DoctrineBundle\Middleware\BacktraceDebugDataHolder([])), ($container->services['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)));
        $e->setConnectionName('default');

        $c->setSchemaManagerFactory(new \Doctrine\DBAL\Schema\LegacySchemaManagerFactory());
        $c->setMiddlewares([new \Doctrine\DBAL\Logging\Middleware($d), $e]);
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'contao.repository.altcha' => ['privates', 'contao.repository.altcha', 'getContao_Repository_AltchaService', true],
            'contao.repository.cron_job' => ['privates', 'contao.repository.cron_job', 'getContao_Repository_CronJobService', true],
        ], [
            'contao.repository.altcha' => '?',
    ...
    {
        return $container->services['fos_http_cache.event_listener.cache_control'] = new \FOS\HttpCacheBundle\EventListener\CacheControlListener('X-Cache-Debug');
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        return $container->services['http_kernel'] = new \Symfony\Component\HttpKernel\HttpKernel($a, $b, ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), new \Symfony\Component\HttpKernel\Controller\TraceableArgumentResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver(new \Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadataFactory(), new RewindableGenerator(function () use ($container) {
            ...
            yield 3 => ($container->privates['.debug.value_resolver.contao.model_argument_resolver'] ?? $container->load('get_Debug_ValueResolver_Contao_ModelArgumentResolverService'));
            ...
            'contao.model_argument_resolver' => ['privates', '.debug.value_resolver.contao.model_argument_resolver', 'get_Debug_ValueResolver_Contao_ModelArgumentResolverService', true],
        ], [
    ...
    protected static function getMessenger_DefaultBusService($container)
    {
        return $container->services['messenger.default_bus'] = new \Symfony\Component\Messenger\TraceableMessageBus(new \Symfony\Component\Messenger\MessageBus(new RewindableGenerator(function () use ($container) {
            ...
            yield 5 => ($container->privates['messenger.bus.default.middleware.doctrine_ping_connection'] ?? $container->load('getMessenger_Bus_Default_Middleware_DoctrinePingConnectionService'));
            yield 6 => ($container->privates['messenger.bus.default.middleware.doctrine_close_connection'] ?? $container->load('getMessenger_Bus_Default_Middleware_DoctrineCloseConnectionService'));
    ...
    {
        return $container->services['translator'] = new \Contao\CoreBundle\Translation\Translator(($container->privates['contao.translation.data_collector_translator'] ?? self::getContao_Translation_DataCollectorTranslatorService($container)), ($container->services['contao.framework'] ?? self::getContao_FrameworkService($container)), ($container->services['contao.resource_finder'] ?? self::getContao_ResourceFinderService($container)));
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $container->services['twig'] = $instance = new \Twig\Environment($b, ['debug' => true, 'strict_variables' => true, 'autoescape' => 'name', 'cache' => ($container->targetDir.''.'/twig'), 'charset' => 'UTF-8']);
        ...
        $g = ($container->services['security.token_storage'] ?? self::getSecurity_TokenStorageService($container));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\SecurityExtension(($container->services['security.authorization_checker'] ?? self::getSecurity_AuthorizationCheckerService($container)), new \Symfony\Component\Security\Http\Impersonate\ImpersonateUrlGenerator($f, ($container->services['security.firewall.map'] ?? self::getSecurity_Firewall_MapService($container)), $g)));
    ...
    protected static function get_Debug_HttpClientService($container)
    {
        ...
        if (isset($container->privates['.debug.http_client'])) {
            return $container->privates['.debug.http_client'];
        }

        return $container->privates['.debug.http_client'] = new \Symfony\Component\HttpClient\TraceableHttpClient(new \Symfony\Component\HttpClient\UriTemplateHttpClient($a, NULL, []), ($container->services['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)));
    }
    ...
    protected static function getCache_AnnotationsService($container)
    {
        ...
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Fsxh8EdLhM', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), $a));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ciShqGgk3d', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xoit72EHx7', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vefCg3Aysd', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lk+gkn++DA', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('P1baPZMy-W', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
     ...
     */
    protected static function getContao_DataCollectorService($container)
    {
        ...
        if (isset($container->privates['contao.data_collector'])) {
            return $container->privates['contao.data_collector'];
        }

        $container->privates['contao.data_collector'] = $instance = new \Contao\CoreBundle\DataCollector\ContaoDataCollector($a);
    ...
    {
        return $container->privates['contao.listener.csrf_token_cookie'] = new \Contao\CoreBundle\EventListener\CsrfTokenCookieSubscriber(($container->services['contao.csrf.token_manager'] ?? self::getContao_Csrf_TokenManagerService($container)), ($container->privates['contao.csrf.token_storage'] ??= new \Contao\CoreBundle\Csrf\MemoryTokenStorage()), 'csrf_');
    }
     ...
     */
    protected static function getContao_Translation_DataCollectorTranslatorService($container)
    {
        return $container->privates['contao.translation.data_collector_translator'] = new \Contao\CoreBundle\Translation\DataCollectorTranslator(new \Symfony\Component\Translation\DataCollectorTranslator(($container->privates['translator.default'] ?? self::getTranslator_DefaultService($container))));
    }
    ...
    protected static function getContao_Twig_Loader_AutoRefreshTemplateHierarchyListenerService($container)
    {
        ...
        return $container->privates['contao.twig.loader.auto_refresh_template_hierarchy_listener'] = new \Contao\CoreBundle\Twig\Loader\AutoRefreshTemplateHierarchyListener($a, 'dev');
    }
    ...
    protected static function getDebug_Security_Access_DecisionManagerService($container)
    {
        ...
        return $container->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () use ($container) {
            ...
            yield 4 => ($container->privates['.debug.security.voter.contao.security.data_container.table_access_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_TableAccessVoterService'));
            yield 5 => ($container->privates['.debug.security.voter.contao.security.backend_access_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_BackendAccessVoterService'));
            yield 6 => ($container->privates['.debug.security.voter.contao.security.data_container.article_content_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_ArticleContentVoterService'));
            yield 7 => ($container->privates['.debug.security.voter.contao.security.data_container.content_composition_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_ContentCompositionVoterService'));
            yield 8 => ($container->privates['.debug.security.voter.contao.security.data_container.content_element_nesting_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_ContentElementNestingVoterService'));
            yield 9 => ($container->privates['.debug.security.voter.contao.security.data_container.content_element_type_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_ContentElementTypeVoterService'));
            yield 10 => ($container->privates['.debug.security.voter.contao.security.data_container.favorites_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_FavoritesVoterService'));
            yield 11 => ($container->privates['.debug.security.voter.contao.security.data_container.form_access_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_FormAccessVoterService'));
            yield 12 => ($container->privates['.debug.security.voter.contao.security.data_container.form_field_access_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_FormFieldAccessVoterService'));
            yield 13 => ($container->privates['.debug.security.voter.contao.security.data_container.frontend_module_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_FrontendModuleVoterService'));
            yield 14 => ($container->privates['.debug.security.voter.contao.security.data_container.image_size_access_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_ImageSizeAccessVoterService'));
            yield 15 => ($container->privates['.debug.security.voter.contao.security.data_container.image_size_item_access_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_ImageSizeItemAccessVoterService'));
            yield 16 => ($container->privates['.debug.security.voter.contao.security.data_container.layout_access_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_LayoutAccessVoterService'));
            yield 17 => ($container->privates['.debug.security.voter.contao.security.data_container.page_permission_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_PagePermissionVoterService'));
            yield 18 => ($container->privates['.debug.security.voter.contao.security.data_container.page_type_access_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_PageTypeAccessVoterService'));
            yield 19 => ($container->privates['.debug.security.voter.contao.security.data_container.undo_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_UndoVoterService'));
            yield 20 => ($container->privates['.debug.security.voter.contao.security.data_container.user_access_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_UserAccessVoterService'));
            yield 21 => ($container->privates['.debug.security.voter.contao.security.member_group_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_MemberGroupVoterService'));
            yield 22 => ($container->privates['.debug.security.voter.contao_faq.security.faq_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoFaq_Security_FaqAccessVoterService'));
            yield 23 => ($container->privates['.debug.security.voter.contao_faq.security.faq_category_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoFaq_Security_FaqCategoryAccessVoterService'));
            yield 24 => ($container->privates['.debug.security.voter.contao_news.security.news_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoNews_Security_NewsAccessVoterService'));
            yield 25 => ($container->privates['.debug.security.voter.contao_news.security.news_archive_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoNews_Security_NewsArchiveAccessVoterService'));
            yield 26 => ($container->privates['.debug.security.voter.contao_news.security.news_content_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoNews_Security_NewsContentVoterService'));
            yield 27 => ($container->privates['.debug.security.voter.contao_calendar.security.calendar_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoCalendar_Security_CalendarAccessVoterService'));
            yield 28 => ($container->privates['.debug.security.voter.contao_calendar.security.calendar_content_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoCalendar_Security_CalendarContentVoterService'));
            yield 29 => ($container->privates['.debug.security.voter.contao_calendar.security.calendar_events_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoCalendar_Security_CalendarEventsAccessVoterService'));
            yield 30 => ($container->privates['.debug.security.voter.contao_newsletter.security.newsletter_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoNewsletter_Security_NewsletterAccessVoterService'));
            yield 31 => ($container->privates['.debug.security.voter.contao_newsletter.security.newsletter_channel_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoNewsletter_Security_NewsletterChannelAccessVoterService'));
            yield 32 => ($container->privates['.debug.security.voter.contao_newsletter.security.newsletter_recipients_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoNewsletter_Security_NewsletterRecipientsAccessVoterService'));
            yield 33 => ($container->privates['.debug.security.voter.contao.security.default_data_container_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DefaultDataContainerVoterService'));
    ...
    /**
     * Gets the private 'debug.security.event_dispatcher.contao_backend' shared service.
     *
     * @return \Symfony\Component\EventDispatcher\Debug\TraceableEventDispatcher
     */
    protected static function getDebug_Security_EventDispatcher_ContaoBackendService($container)
    {
        $a = ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container));

        if (isset($container->privates['debug.security.event_dispatcher.contao_backend'])) {
            return $container->privates['debug.security.event_dispatcher.contao_backend'];
        }

        $container->privates['debug.security.event_dispatcher.contao_backend'] = $instance = new \Symfony\Component\EventDispatcher\Debug\TraceableEventDispatcher(new \Symfony\Component\EventDispatcher\EventDispatcher(), ($container->services['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)), $a, ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()));
    ...
    /**
     * Gets the private 'debug.security.event_dispatcher.contao_frontend' shared service.
     *
     * @return \Symfony\Component\EventDispatcher\Debug\TraceableEventDispatcher
     */
    protected static function getDebug_Security_EventDispatcher_ContaoFrontendService($container)
    {
    ...
    protected static function getDebug_Security_FirewallService($container)
    {
        ...
        return $container->privates['debug.security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener($a, $b, ($container->services['security.logout_url_generator'] ?? self::getSecurity_LogoutUrlGeneratorService($container)));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('8UXMsmCIyZ', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['fos_http_cache.event_listener.attributes'] = new \FOS\HttpCacheBundle\EventListener\AttributesListener(($container->privates['contao.controller_resolver'] ?? self::getContao_ControllerResolverService($container)));
    }
    ...
    protected static function getFosHttpCache_EventListener_TagService($container)
    {
        ...
        return $container->privates['fos_http_cache.event_listener.tag'] = new \FOS\HttpCacheBundle\EventListener\TagListener($a, ($container->services['fos_http_cache.http.symfony_response_tagger'] ?? self::getFosHttpCache_Http_SymfonyResponseTaggerService($container)), new \FOS\HttpCacheBundle\Http\RuleMatcher(new \FOS\HttpCacheBundle\Http\RequestMatcher\CacheableRequestMatcher(), new \FOS\HttpCacheBundle\Http\ResponseMatcher\CacheableResponseMatcher([])), new \FOS\HttpCacheBundle\Http\RuleMatcher(new \FOS\HttpCacheBundle\Http\RequestMatcher\UnsafeRequestMatcher(), new \FOS\HttpCacheBundle\Http\ResponseMatcher\NonErrorResponseMatcher()), NULL);
    }
    ...
    {
        $container->privates['monolog.handler.main'] = $instance = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).'/logs/dev.log'), 10, 'debug', true, NULL, false);
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['scheb_two_factor.trusted_cookie_response_listener'] = $container->createProxy('TrustedCookieResponseListenerGhost2528a3a', static fn () => \TrustedCookieResponseListenerGhost2528a3a::createLazyGhost(static fn ($proxy) => self::getSchebTwoFactor_TrustedCookieResponseListenerService($container, $proxy)));
        }
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['scheb_two_factor.trusted_token_storage'] = $container->createProxy('TrustedDeviceTokenStorageGhostE7836e7', static fn () => \TrustedDeviceTokenStorageGhostE7836e7::createLazyGhost(static fn ($proxy) => self::getSchebTwoFactor_TrustedTokenStorageService($container, $proxy)));
        }
        ...
        return ($lazyLoad->__construct(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), new \Scheb\TwoFactorBundle\Security\TwoFactor\Trusted\TrustedDeviceTokenEncoder(new \Scheb\TwoFactorBundle\Security\TwoFactor\Trusted\JwtTokenEncoder(\Lcobucci\JWT\Configuration::forSymmetricSigner(new \Lcobucci\JWT\Signer\Hmac\Sha256(), \Lcobucci\JWT\Signer\Key\InMemory::plainText($container->getEnv('APP_SECRET')))), 5184000), 'trusted_device') && false ?: $lazyLoad);
    }
    ...
    protected static function getSecurity_ContextListener_0Service($container)
    {
        ...
        $b = ($container->privates['debug.security.event_dispatcher.contao_backend'] ?? self::getDebug_Security_EventDispatcher_ContaoBackendService($container));
    ...
    {
        $a = ($container->privates['debug.security.event_dispatcher.contao_frontend'] ?? self::getDebug_Security_EventDispatcher_ContaoFrontendService($container));
        ...
        return $container->privates['security.context_listener.1'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['contao.security.backend_user_provider'] ?? $container->load('getContao_Security_BackendUserProviderService'));
            yield 1 => ($container->privates['contao.security.frontend_user_provider'] ?? $container->load('getContao_Security_FrontendUserProviderService'));
        }, 2), 'contao_frontend', ($container->privates['monolog.logger.security'] ?? self::getMonolog_Logger_SecurityService($container)), $a, ($container->services['security.authentication.trust_resolver'] ?? self::getSecurity_Authentication_TrustResolverService($container)), [($container->services['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), 'enableUsageTracking']);
    }
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'contao.resources_paths' => [
                0 => (\dirname(__DIR__, 4).'/vendor/contao/core-bundle/contao'),
                1 => (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/contao'),
                2 => (\dirname(__DIR__, 4).'/vendor/contao/faq-bundle/contao'),
                3 => (\dirname(__DIR__, 4).'/vendor/contao/news-bundle/contao'),
                4 => (\dirname(__DIR__, 4).'/vendor/contao/listing-bundle/contao'),
                5 => (\dirname(__DIR__, 4).'/vendor/contao/calendar-bundle/contao'),
                6 => (\dirname(__DIR__, 4).'/vendor/contao/newsletter-bundle/contao'),
                7 => (\dirname(__DIR__, 4).'/vendor/contao/comments-bundle/contao'),
            ],
            'console.command.ids' => [
