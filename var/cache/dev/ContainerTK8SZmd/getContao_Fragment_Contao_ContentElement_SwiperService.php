...
class getContao_Fragment_Contao_ContentElement_SwiperService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = $container->load('get_ServiceLocator_98PWvJa_Contao_Fragment_Contao_ContentElement_SwiperService');

        $instance->setContainer($a);
        $instance->setFragmentOptions(['type' => 'swiper', 'category' => 'miscellaneous', 'template' => 'content_element/swiper', 'method' => NULL, 'renderer' => NULL, 'nestedFragments' => true, 'debugController' => 'Contao\\CoreBundle\\Controller\\ContentElement\\SwiperController']);
        $instance->setContainer($a);
