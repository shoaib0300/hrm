 ...
 */
class getContao_Fragment_Contao_ContentElement_DownloadService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = $container->load('get_ServiceLocator_Xxy2XMy_Contao_Fragment_Contao_ContentElement_DownloadService');

        $instance->setContainer($a);
        $instance->setFragmentOptions(['type' => 'download', 'category' => 'files', 'template' => 'content_element/download', 'method' => NULL, 'renderer' => NULL, 'nestedFragments' => false, 'debugController' => 'Contao\\CoreBundle\\Controller\\ContentElement\\DownloadsController']);
        $instance->setContainer($a);
