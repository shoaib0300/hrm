 ...
 */
class getMessenger_Bus_Default_Middleware_HandleMessageService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 1), 'Contao\\CoreBundle\\Messenger\\Message\\SearchIndexMessage' => new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['.messenger.handler_descriptor.TJmyKNv'] ?? $container->load('get_Messenger_HandlerDescriptor_TJmyKNvService'));
        }, 1)]), false);
