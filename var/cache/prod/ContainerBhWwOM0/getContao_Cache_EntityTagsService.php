...
class getContao_Cache_EntityTagsService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['contao.cache.entity_tags'] = new \Contao\CoreBundle\Cache\EntityCacheTags($a, ($container->services['fos_http_cache.http.symfony_response_tagger'] ?? self::getFosHttpCache_Http_SymfonyResponseTaggerService($container)), $b);
    }
}
