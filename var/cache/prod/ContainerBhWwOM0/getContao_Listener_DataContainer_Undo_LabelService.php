...
class getContao_Listener_DataContainer_Undo_LabelService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['contao.listener.data_container.undo.label'] = new \Contao\CoreBundle\EventListener\DataContainer\Undo\LabelListener(($container->services['contao.framework'] ?? self::getContao_FrameworkService($container)), ($container->services['twig'] ?? self::getTwigService($container)));
    }
}
