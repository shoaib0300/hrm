...
class getMarkdownControllerService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.1Au3X34'] ?? $container->load('get_ServiceLocator_1Au3X34Service'))->withContext('Contao\\CoreBundle\\Controller\\ContentElement\\MarkdownController', $container));
