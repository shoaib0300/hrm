...
class getContao_Fragment_Contao_FrontendModule_TwoFactorService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = $container->load('get_ServiceLocator_P4DRd9S_Contao_Fragment_Contao_FrontendModule_TwoFactorService');

        $instance->setContainer($a);
        $instance->setFragmentOptions(['type' => 'two_factor', 'category' => 'user', 'template' => 'mod_two_factor', 'method' => NULL, 'renderer' => NULL, 'debugController' => 'Contao\\CoreBundle\\Controller\\FrontendModule\\TwoFactorController']);
        $instance->setContainer($a);
