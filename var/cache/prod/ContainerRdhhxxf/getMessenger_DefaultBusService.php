 ...
 */
class getMessenger_DefaultBusService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['messenger.default_bus'] = new \Symfony\Component\Messenger\MessageBus(new RewindableGenerator(function () use ($container) {
            ...
            yield 4 => ($container->privates['messenger.bus.default.middleware.doctrine_ping_connection'] ?? $container->load('getMessenger_Bus_Default_Middleware_DoctrinePingConnectionService'));
            yield 5 => ($container->privates['messenger.bus.default.middleware.doctrine_close_connection'] ?? $container->load('getMessenger_Bus_Default_Middleware_DoctrineCloseConnectionService'));
