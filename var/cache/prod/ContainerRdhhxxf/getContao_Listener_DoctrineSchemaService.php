...
class getContao_Listener_DoctrineSchemaService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['contao.listener.doctrine_schema'] = new \Contao\CoreBundle\EventListener\DoctrineSchemaListener(new \Contao\CoreBundle\Doctrine\Schema\DcaSchemaProvider(($container->services['contao.framework'] ?? self::getContao_FrameworkService($container)), ($container->services['doctrine'] ?? $container->load('getDoctrineService'))), $a);
    }
}
