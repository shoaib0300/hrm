 ...
 */
class getSchebTwoFactor_ConditionRegistryService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    /*
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['scheb_two_factor.condition_registry'] = $container->createProxy('TwoFactorConditionRegistryGhost9281564', static fn () => \TwoFactorConditionRegistryGhost9281564::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
