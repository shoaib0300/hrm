...
class getTwoFactorControllerService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.p4DRd9S'] ?? $container->load('get_ServiceLocator_P4DRd9SService'))->withContext('Contao\\CoreBundle\\Controller\\FrontendModule\\TwoFactorController', $container));
