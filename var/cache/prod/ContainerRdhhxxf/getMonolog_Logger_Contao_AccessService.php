...
class getMonolog_Logger_Contao_AccessService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['monolog.logger.contao.access'])) {
            return $container->services['monolog.logger.contao.access'];
        }
        $b = new \Monolog\Logger('contao.access');
        ...
        return $container->services['monolog.logger.contao.access'] = new \Contao\CoreBundle\Monolog\SystemLogger($b, 'ACCESS');
    }
}
