...
class getFosHttpCache_Command_RefreshPathService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['fos_http_cache.command.refresh_path'] = $instance = new \FOS\HttpCacheBundle\Command\RefreshPathCommand(($container->services['fos_http_cache.cache_manager'] ?? self::getFosHttpCache_CacheManagerService($container)));
