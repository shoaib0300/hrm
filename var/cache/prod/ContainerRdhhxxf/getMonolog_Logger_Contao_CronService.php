...
class getMonolog_Logger_Contao_CronService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['monolog.logger.contao.cron'])) {
            return $container->services['monolog.logger.contao.cron'];
        }
        $b = new \Monolog\Logger('contao.cron');
        ...
        return $container->services['monolog.logger.contao.cron'] = new \Contao\CoreBundle\Monolog\SystemLogger($b, 'CRON');
    }
}
